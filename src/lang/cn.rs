...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "就绪"),
        ("Established", "已建立"),
        ("connecting_status", "正在接入 Deskon 网络..."),
        ("Enable service", "允许服务"),
        ("Start service", "启动服务"),
        ...
        ("Turned off", "退出"),
        ("Language", "语言"),
        ("Keep Deskon background service", "保持 Deskon 后台服务"),
        ...
        ("printer-requires-installed-{}-client-tip", "请先安装 {} 打印机。"),
        ...
        ("Password too short, minimum 8 characters", "密码至少8个字符"),
        ("Please confirm password", "请确认密码"),
        ("Passwords do not match", "两次密码不一致"),
        ("Registration successful", "注册成功"),
        ("Registration failed", "注册失败"),
        ("API server not configured", "API服务器未配置"),
        ("Server response error", "服务器响应错误"),
        ...
        ("Local ID", "本机ID"),
        ("One-time Password", "一次性密码"),
        ("Server returned empty response", "服务器返回空响应"),
        ("Server response error: Invalid JSON format", "服务器响应错误：无效的JSON格式"),
        ("Registration endpoint not found. Please check API server configuration.", "注册接口未找到，请检查API服务器配置"),
        ("Registration endpoint not found. Server returned HTML page.", "注册接口未找到，服务器返回了HTML页面"),
        ("Username must be at least 3 characters", "用户名至少需要3个字符"),
        ("Password must be 8-20 characters", "密码长度必须在8-20个字符之间"),
        ("Registration failed: Unknown response format", "注册失败：未知的响应格式"),
        ("Optional", "可选"),
    ].iter().cloned().collect();
}
