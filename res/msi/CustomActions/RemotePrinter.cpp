...
#define HRESULT_ERR_ELEMENT_NOT_FOUND 0x80070490
    ...
    LPCWCH RD_PRINTER_PORT = L"Deskon Printer";
    LPCWCH RD_PRINTER_NAME = L"Deskon Printer";
    LPCWCH RD_PRINTER_DRIVER_NAME = L"Deskon v4 Printer Driver";
    ...
    {
        // If the printer is used after the spooler service is started. E.g., printing a document through Deskon Printer.
